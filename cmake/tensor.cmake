...
# MSVC: parallel execution works out of the box.
# libstdc++: uses Intel TBB as the parallel back-end when TBB is installed and
# falls back to serial execution when its headers are absent, so TBB is linked
# only when CMake actually finds it.
if(NOT MSVC)
