/**
 * @file  beta_avx2.cpp
 * @brief AVX2 (256-bit, 4-wide) implementation of the beta batch kernel.
 *
 * Module:  src/simd/
 ...
 *
 * Correctness guarantee: produces bit-identical results to compute_beta_scalar()
 * for any input, because both use the same batch_max before dividing.
 *
...
// Horizontal max of 4-lane __m256d → scalar double.
