#!/usr/bin/env python3
# Manual benchmark script — NOT a Criterion benchmark.
# Run directly: python3 scripts/mcp_bench.py
# This script drives the MCP server over stdio JSON-RPC and measures
# latency for infer calls.  It is not wired into `cargo bench`.
"""
