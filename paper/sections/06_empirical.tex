...
\paragraph{Cross-sectional consistency.} The pooled Bartlett test (less sensitive to non-normality) is significant at $p = 6.0 \times 10^{-16}$, consistent with a systematic variance separation effect. Per-asset Levene tests do not reach significance after Bonferroni correction (Cohen's $d = 0.037$ pooled).
