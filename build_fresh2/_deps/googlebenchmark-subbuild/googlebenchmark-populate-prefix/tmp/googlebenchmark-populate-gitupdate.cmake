...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v1.8.3"
  WORKING_DIRECTORY "R:/workspaces/Special-Relativity-in-Financial-Modeling/build_fresh2/_deps/googlebenchmark-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'R:/workspaces/Special-Relativity-in-Financial-Modeling/build_fresh2/_deps/googlebenchmark-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'R:/workspaces/Special-Relativity-in-Financial-Modeling/build_fresh2/_deps/googlebenchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
